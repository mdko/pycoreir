...
if [[ "$TRAVIS_OS_NAME" == "linux" ]]; then
    ...
    docker exec manylinux bach -c "git config --global user.email 'setaluri@stanford.edu'"
    docker exec manylinux bach -c "git config --global user.name 'Raj Setaluri (travis)'"
